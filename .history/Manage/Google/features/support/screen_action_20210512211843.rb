...
def list_before()
    list_A = $driver.find_element(:xpath, '//*[@id="__layout"]/div/div[3]/div/div/div[2]/div[2]/div[3]/div[2]/div[2]/div/ul').size
    if list_A > 0
        return
    end
end 
...
def list_after()
    list_B = $driver.find_element(:xpath, '//*[@id="__layout"]/div/div[3]/div/div/div[2]/div[2]/div[3]/div[2]/div[2]/div/ul').size
    if list_B > 0
        return
    end
end 
