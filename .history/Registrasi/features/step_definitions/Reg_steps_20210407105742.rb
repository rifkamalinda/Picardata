...
Then('user input Email') do
  ...
  driver.find_element(:xpath, '//*[@id="content-wrapper"]/div/div/div/div[3]/div/div/form/div[1]/input').send_keys 'tesmike1230@gmail.com'
  sleep(3)
end

Then('user input password') do
  driver.find_element(:xpath, '//*[@id="content-wrapper"]/div/div/div/div[3]/div/div/form/div[2]/input').click
  driver.find_element(:xpath, '//*[@id="content-wrapper"]/div/div/div/div[3]/div/div/form/div[2]/input').send_keys 'Mike4321'
  sleep(3)
end
...
Then('user continue to complete profile and should see {string}') do |string|
  string = driver.find_element(:xpath, '//*[@id="content-wrapper"]/div/div/div/div[3]/div').text
  string.should == "How Picardata works?"
  driver.find_element(:xpath, '//*[@id="content-wrapper"]/div/div/div/div[5]/div/button[2]').click
end

Then('user fill the fields and should see {string}') do |string|
  string = driver.find_element(:xpath, '//*[@id="content-wrapper"]/div/div/div/div[3]/div/h3/text()').text
