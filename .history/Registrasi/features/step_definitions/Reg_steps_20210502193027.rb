...
Then('user input Email') do
  $driver.find_element(:xpath, '//*[@id="__layout"]/div/div/div/div/div[1]/div[2]/input').send_keys 'terustes1212@gmail.com'
  sleep(3)
end

Then('user input password') do
  $driver.find_element(:xpath, '//*[@id="__layout"]/div/div/div/div/div[1]/div[3]/input').send_keys 'Teee$1212!'
  sleep(3)
  $driver.find_element(:xpath, '//*[@id="__layout"]/div/div/div/div/div[1]/div[4]/input').send_keys 'Teee$1212!'
  sleep(5)
end
...
Then('user fill the fields and should see {string}') do |string|
  ...
  sleep(5)
  $driver.find_element(:id, 'MazPhoneNumberInput-25_country_selector').click
  sleep(2)
  $driver.find_element(:id, 'MazPhoneNumberInput-25_country_selector').send_keys "Indonesia"
  sleep(2)
