...
Then('user input Email') do
  $driver.find_element(:xpath, '//*[@id="__layout"]/div/div/div/div/div[1]/div[2]/input').send_keys 'terustes1232@gmail.com'
  sleep(3)
end

Then('user input password') do
  $driver.find_element(:xpath, '//*[@id="__layout"]/div/div/div/div/div[1]/div[3]/input').send_keys 'Teee$1234!'
  sleep(3)
  $driver.find_element(:xpath, '//*[@id="__layout"]/div/div/div/div/div[1]/div[4]/input').send_keys 'Teee$1234!'
  sleep(5)
end
...
Then('user fill the fields and should see {string}') do |string|
  ...
  $driver.find_element(:xpath, '//*[@id="content-wrapper"]/div/div/div/div[3]/div[2]/span/form/div/div[2]/span[1]/input').send_keys "Mike"
  sleep(2)
  ...
  sleep(2)
  $driver.find_element(:xpath, '//*[@id="MazPhoneNumberInput-77_country_selector"]').click
  sleep(2)
  $driver.find_element(:xpath, '//*[@id="MazPhoneNumberInput-77_country_selector"]').send_keys "Indonesia"
  sleep(2)
  $driver.find_element(:xpath, '//*[@id="MazPhoneNumberInput-77_phone_number"]').send_keys "85912345678"
  sleep(2)
