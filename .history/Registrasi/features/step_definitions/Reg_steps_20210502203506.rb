...
Then('user input Email') do
  $driver.find_element(:xpath, '//*[@id="__layout"]/div/div/div/div/div[1]/div[2]/input').send_keys 'terustes1038@gmail.com'
  sleep(3)
end

Then('user input password') do
  $driver.find_element(:xpath, '//*[@id="__layout"]/div/div/div/div/div[1]/div[3]/input').send_keys 'Te$1038!'
  sleep(3)
  $driver.find_element(:xpath, '//*[@id="__layout"]/div/div/div/div/div[1]/div[4]/input').send_keys 'Te$1038!'
  sleep(5)
end
...
Then('user fill the fields and should see {string}') do |string|
  ...
  sleep(2)
  $driver.find_element(:id, 'MazPhoneNumberInput-46_phone_number').send_keys "87654321"
  sleep(2)
...
Then('user should see Homepage') do
  al = $driver.find_element(:xpath, '//*[@id="content-wrapper"]/div/div/div/div[2]/div/div[1]/div/div/div/div/nav/nav/ol/li[3]').text
