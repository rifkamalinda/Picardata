...
Then('user input password') do
  $driver.find_element(:xpath, '//*[@id="__layout"]/div/div/div/div/div[1]/div[3]/input').send_keys 'To$1234!'
  sleep(3)
  $driver.find_element(:xpath, '//*[@id="__layout"]/div/div/div/div/div[1]/div[4]/input').send_keys 'To$1234!'
  sleep(5)
end

Then('user click on Register button') do
  driver.find_element(:css, '[type='button'][class='btn btn-primary btn-block mt-4 mb-4 rounded btn-register']').click
  sleep(10)
end
